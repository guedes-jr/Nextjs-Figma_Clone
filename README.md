<div align="center">
  ...
  <h3 align="center">Figma Clone com Real time</h3>

   <div align="center">
     Tutorial detalhado em <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> no YouTube! <br />
...
Um clone minimalista do Figma para mostrar como adicionar recursos do mundo real, como colaboração ao vivo com bate-papo com cursor, comentários, reações e designs de desenho (formas, upload de imagens) na tela usando fabric.js.
...
✔️ **Multicursores, bate-papo com cursor e reações:** Permite que vários usuários colaborem simultaneamente, mostrando cursores individuais, permitindo bate-papo em tempo real e reações para comunicação interativa.

✔️ **Usuários Ativos:** Exibe uma lista de usuários atualmente ativos no ambiente colaborativo, proporcionando visibilidade sobre quem está engajado no momento.

✔️ **Bolhas de comentários:** Permitem que os usuários anexem comentários a elementos específicos na tela, promovendo a comunicação e feedback sobre os componentes do design.

✔️ **Criando Formas Diferentes:** Fornece ferramentas para os usuários gerarem uma variedade de formas na tela, permitindo diversos elementos de design

✔️ **Upload de imagens:** Importe imagens para a tela, ampliando a gama de conteúdo visual no design

✔️ **Personalização:** Permite aos usuários ajustar as propriedades dos elementos de design, oferecendo flexibilidade na personalização e ajuste fino dos componentes visuais

✔️ **Desenho de forma livre:** Permite aos usuários desenhar livremente na tela, promovendo a expressão artística e o design criativo.

✔️ **Desfazer/Refazer:** Oferece a capacidade de reverter (desfazer) ou restaurar (refazer) ações anteriores, oferecendo flexibilidade na tomada de decisões de design

✔️ **Ações do teclado:** Permite que os usuários utilizem atalhos de teclado para várias ações, incluindo copiar, colar, excluir e acionar atalhos para recursos como abertura de bate-papo com cursor, reações e muito mais, aumentando a eficiência e a acessibilidade.

✔️ **Histórico:** Revise o histórico cronológico das ações e alterações realizadas no canvas, auxiliando no gerenciamento de projetos e controle de versões.

✔️ **Excluir, dimensionar, mover, limpar, exportar tela:** Oferece uma variedade de funções para gerenciar elementos de design, incluindo exclusão, dimensionamento, movimentação, limpeza da tela e exportação do design final para uso externo.

e muito mais, incluindo arquitetura de código, ganchos de reação avançados e capacidade de reutilização
...
- [npm](https://www.npmjs.com/) (gerenciador de pacotes de nós)
...
Crie um novo arquivo nomeado `.env.local` raiz do seu projeto e adicione o seguinte conteúdo:
```env
NEXT_PUBLIC_LIVEBLOCKS_PUBLIC_KEY=
```

Substitua os valores do espaço reservado pelas suas credenciais reais do Liveblocks. Você pode obter essas credenciais inscrevendo-se no [Liveblocks website](https://liveblocks.io).
...
## <a name="more">🚀 Referências</a>

**Projeto baseado no projeto do canal [JavaScript Mastery](https://www.youtube.com/@javascriptmastery) | [Build and Deploy a Figma Clone](https://youtu.be/oKIThIihv60)** 